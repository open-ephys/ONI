...
power-on. Whenever a device receives a soft reset request generated by the
...
A hard :ref:`hard reset<hard_reset>` MUST always reset them to their power-on value.
...
runtime, but registers affecting it might take action after a soft reset, providing
